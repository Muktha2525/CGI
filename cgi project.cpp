...
void display()
{
    ...
    if (value == -1)
    {
        char cn[] = "SJM INSTITUTE OF TECHNOLOGY ";
        drawhead(-620, 900, 0, cn);
        char pn[] = "CHITRADURGA-577501";
        ...
        char p2[] = "HALEEMA MISBAH NOORAIN";
        ...
        char g1[] = "PROF.SHRUTHI M K";
        drawhead(290, -250, 0, g1);
        char d1[] = "Professor, Dept. Of CSE, SJMIT";
        drawsubhead(290, -300, 0, d1);

        //char g2[] = "NEELAKANTAPPA T T";
        //drawhead(290, -400, 0, g2);
        //char d2[] = "Assistant Professor, Dept. of CSE, SJMIT";
